...
var SignInModal = (function () {
    ...
    SignInModal.prototype.signIn = function () {
        var _this = this;
        this._meshRiseService.signIn(this.signInObject).subscribe(function (result) { }, function (err) { console.error(err); __WEBPACK_IMPORTED_MODULE_5_sweetalert2___default()('Oops...', 'Something went wrong!', 'error'); }, function () {
            __WEBPACK_IMPORTED_MODULE_5_sweetalert2___default()('Good job!', 'sign In!', 'success');
            _this._meshRiseService.store(_this.signInObject);
